...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Enterprise & Agile Transformation', href: '/services/transformation' },
      { label: 'Digital & Platform Engineering', href: '/services/digital-platform' },
      { label: 'Data, ML & AI', href: '/services/data-ml-ai' },
      { label: 'Venture Building', href: '/services/venture-building' },
      { label: 'Operating Model', href: '/services/operating-model' },
    ],
  },
  {
    title: 'More',
